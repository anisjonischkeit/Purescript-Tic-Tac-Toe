...
(function(exports) {
  ...
  var always_ = function ($29) {
      return Data_Function["const"](Data_Maybe.Just.create($29));
  };
...
(function(exports) {
  ...
  var Data_Show = PS["Data.Show"];
  var Prelude = PS["Prelude"];                 
  var NonExistantBoardPosition = (function () {
      function NonExistantBoardPosition() {

      };
      NonExistantBoardPosition.value = new NonExistantBoardPosition();
      return NonExistantBoardPosition;
  })();
  var NonEmptyTileExistsAtPosition = (function () {
      function NonEmptyTileExistsAtPosition() {

      };
      NonEmptyTileExistsAtPosition.value = new NonEmptyTileExistsAtPosition();
      return NonEmptyTileExistsAtPosition;
  })();
  ...
  // BoardState
  var Winner = (function () {
      function Winner(value0) {
          this.value0 = value0;
      };
      Winner.create = function (value0) {
          return new Winner(value0);
      };
      return Winner;
  })();
  ...
  var showPiece = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at TicTacToe line 17, column 10 - line 21, column 1: " + [ v.constructor.name ]);
  });
  var place = function (board) {
      return function (pos) {
          return function (piece) {
              var row = Data_Array.index(board)(pos.y);
              var newRow = (function () {
                  if (row instanceof Data_Maybe.Nothing) {
                      return new Data_Either.Left(NonExistantBoardPosition.value);
                  };
                  if (row instanceof Data_Maybe.Just) {
                      var v = Data_Array.index(row.value0)(pos.x);
                      if (v instanceof Data_Maybe.Nothing) {
                          return new Data_Either.Left(NonExistantBoardPosition.value);
                      };
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Just) {
                          return new Data_Either.Left(NonEmptyTileExistsAtPosition.value);
                      };
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Nothing) {
                          var v1 = Data_Array.updateAt(pos.x)(new Data_Maybe.Just(piece))(row.value0);
                          if (v1 instanceof Data_Maybe.Nothing) {
                              return new Data_Either.Left(NonExistantBoardPosition.value);
                          };
                          if (v1 instanceof Data_Maybe.Just) {
                          ...
                          throw new Error("Failed pattern match at TicTacToe line 52, column 13 - line 54, column 34: " + [ v1.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at TicTacToe line 48, column 9 - line 54, column 34: " + [ v.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at TicTacToe line 45, column 14 - line 54, column 34: " + [ row.constructor.name ]);
              })();
              var newBoard = Control_Bind.bind(Data_Either.bindEither)(newRow)(function (nr) {
                  var v = Data_Array.updateAt(pos.y)(nr)(board);
                  if (v instanceof Data_Maybe.Nothing) {
                      return new Data_Either.Left(NonExistantBoardPosition.value);
                  };
                  if (v instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at TicTacToe line 58, column 7 - line 60, column 28: " + [ v.constructor.name ]);
              });
              return newBoard;
          };
      };
  };
  var invertPiece = function (v) {
      if (v instanceof X) {
          return O.value;
      };
      if (v instanceof O) {
      ...
      throw new Error("Failed pattern match at TicTacToe line 63, column 15 - line 65, column 9: " + [ v.constructor.name ]);
  };
  var initialBoard = [ [ Data_Maybe.Nothing.value, Data_Maybe.Nothing.value, Data_Maybe.Nothing.value ], [ Data_Maybe.Nothing.value, Data_Maybe.Nothing.value, Data_Maybe.Nothing.value ], [ Data_Maybe.Nothing.value, Data_Maybe.Nothing.value, Data_Maybe.Nothing.value ] ];
  var fullBoard = function (board) {
      if (board.length === 3 && (board[0].length === 3 && (board[0][0] instanceof Data_Maybe.Just && (board[0][1] instanceof Data_Maybe.Just && (board[0][2] instanceof Data_Maybe.Just && (board[1].length === 3 && (board[1][0] instanceof Data_Maybe.Just && (board[1][1] instanceof Data_Maybe.Just && (board[1][2] instanceof Data_Maybe.Just && (board[2].length === 3 && (board[2][0] instanceof Data_Maybe.Just && (board[2][1] instanceof Data_Maybe.Just && board[2][2] instanceof Data_Maybe.Just)))))))))))) {
          return true;
      };
      return false;
  };
  ...
  var allEq = function (dictEq) {
      return function (comparator) {
          return function (xs) {
              return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Eq.eq(dictEq)(comparator))(xs);
          };
      };
  };
  var fullColumn = function (board) {
      return function (piece) {
          if (board.length === 3 && (board[0].length === 3 && (board[0][0] instanceof Data_Maybe.Just && (board[1].length === 3 && (board[1][0] instanceof Data_Maybe.Just && (board[2].length === 3 && board[2][0] instanceof Data_Maybe.Just)))))) {
              return allEq(eqPiece)(piece)([ board[0][0].value0, board[1][0].value0, board[2][0].value0 ]);
          };
          if (board.length === 3 && (board[0].length === 3 && (board[0][1] instanceof Data_Maybe.Just && (board[1].length === 3 && (board[1][1] instanceof Data_Maybe.Just && (board[2].length === 3 && board[2][1] instanceof Data_Maybe.Just)))))) {
              return allEq(eqPiece)(piece)([ board[0][1].value0, board[1][1].value0, board[2][1].value0 ]);
          };
          if (board.length === 3 && (board[0].length === 3 && (board[0][2] instanceof Data_Maybe.Just && (board[1].length === 3 && (board[1][2] instanceof Data_Maybe.Just && (board[2].length === 3 && board[2][2] instanceof Data_Maybe.Just)))))) {
              return allEq(eqPiece)(piece)([ board[0][2].value0, board[1][2].value0, board[2][2].value0 ]);
          };
          return false;
      };
  };
  var fullDiagonal = function (board) {
      return function (piece) {
          if (board.length === 3 && (board[0].length === 3 && (board[0][0] instanceof Data_Maybe.Just && (board[1].length === 3 && (board[1][1] instanceof Data_Maybe.Just && (board[2].length === 3 && board[2][2] instanceof Data_Maybe.Just)))))) {
              return allEq(eqPiece)(piece)([ board[0][0].value0, board[1][1].value0, board[2][2].value0 ]);
          };
          if (board.length === 3 && (board[0].length === 3 && (board[0][2] instanceof Data_Maybe.Just && (board[1].length === 3 && (board[1][1] instanceof Data_Maybe.Just && (board[2].length === 3 && board[2][0] instanceof Data_Maybe.Just)))))) {
              return allEq(eqPiece)(piece)([ board[0][2].value0, board[1][1].value0, board[2][0].value0 ]);
          };
          return false;
      };
  };
  var fullRow = function (board) {
      return function (piece) {
          return Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(allEq(Data_Maybe.eqMaybe(eqPiece))(new Data_Maybe.Just(piece)))(board);
      };
  };
  var getBoardState = function (board) {
      var $121 = fullRow(board)(X.value) || (fullColumn(board)(X.value) || fullDiagonal(board)(X.value));
      if ($121) {
          return new Winner(X.value);
      };
      var $122 = fullRow(board)(O.value) || (fullColumn(board)(O.value) || fullDiagonal(board)(O.value));
      if ($122) {
          return new Winner(O.value);
      };
      var $123 = fullBoard(board);
      if ($123) {
          return Tie.value;
      };
  ...
  exports["X"] = X;
  exports["O"] = O;
  exports["NonExistantBoardPosition"] = NonExistantBoardPosition;
  exports["NonEmptyTileExistsAtPosition"] = NonEmptyTileExistsAtPosition;
  exports["initialBoard"] = initialBoard;
  exports["place"] = place;
  exports["invertPiece"] = invertPiece;
  ...
  exports["fullDiagonal"] = fullDiagonal;
  exports["fullBoard"] = fullBoard;
...
(function(exports) {
  ...
  var tileView = function (tile) {
      return function (pos) {
          return Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(new Play(pos))), Spork_Html_Properties.classes([ "tictactoetile" ]) ])([ Spork_Html_Core.text((function () {
              if (tile instanceof Data_Maybe.Just) {
                  return Data_Show.show(TicTacToe.showPiece)(tile.value0);
              };
              if (tile instanceof Data_Maybe.Nothing) {
                  return ".";
              };
              throw new Error("Failed pattern match at Main line 63, column 14 - line 66, column 5: " + [ tile.constructor.name ]);
          })()) ]);
      };
  };

  // Utils
  var showBoardState = function (model) {
      var v = TicTacToe.getBoardState(model.board);
      if (v instanceof TicTacToe.Playing) {
          return "It's " + (Data_Show.show(TicTacToe.showPiece)(model.player) + "'s turn.");
      };
      if (v instanceof TicTacToe.Winner) {
          return Data_Show.show(TicTacToe.showPiece)(TicTacToe.invertPiece(model.player)) + " has won the game.";
      };
      if (v instanceof TicTacToe.Tie) {
          return "X and O have tied the game.";
      };
      throw new Error("Failed pattern match at Main line 95, column 3 - line 101, column 1: " + [ v.constructor.name ]);
  };
  var initialModel = {
      board: TicTacToe.initialBoard,
      player: TicTacToe.X.value
  };
  var update = function (model) {
      return function (v) {
          if (v instanceof Play) {
              var v1 = TicTacToe.getBoardState(model.board);
              if (v1 instanceof TicTacToe.Playing) {
                  var v2 = TicTacToe.place(model.board)(v.value0)(model.player);
                  if (v2 instanceof Data_Either.Right) {
                      return {
                          board: v2.value0,
                          player: TicTacToe.invertPiece(model.player)
                      };
                  };
                  if (v2 instanceof Data_Either.Left) {
                      return model;
                  };
                  throw new Error("Failed pattern match at Main line 44, column 11 - line 46, column 28: " + [ v2.constructor.name ]);
              };
              return model;
          };
          ...
          throw new Error("Failed pattern match at Main line 40, column 3 - line 50, column 25: " + [ v.constructor.name ]);
      };
  };
  var boardView = function (board) {
      return Spork_Html_Elements.div([  ])(Data_Function.flip(Data_Array.mapWithIndex)(board)(function (y) {
          return function (row) {
              return Spork_Html_Elements.div([  ])(Data_Function.flip(Data_Array.mapWithIndex)(row)(function (x) {
  ...
  var render = function (model) {
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.h1([  ])([ Spork_Html_Core.text("Purescript Tic Tac Toe") ]), Spork_Html_Elements.h2([  ])([ Spork_Html_Core.text(showBoardState(model)) ]), boardView(model.board), Spork_Html_Elements.br([  ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(Reset.value)) ])([ Spork_Html_Core.text("reset") ]) ]);
  };
  ...
  exports["showBoardState"] = showBoardState;
  exports["app"] = app;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();