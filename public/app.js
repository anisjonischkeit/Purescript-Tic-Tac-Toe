...
(function(exports) {
  ...
  var showPiece = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at TicTacToe line 14, column 10 - line 18, column 1: " + [ v.constructor.name ]);
  });
      ...
      return function (pos) {
          return function (piece) {
              ...
              var newRow = (function () {
                  ...
                  if (row instanceof Data_Maybe.Just) {
                      ...
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at TicTacToe line 54, column 13 - line 56, column 34: " + [ v1.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at TicTacToe line 50, column 9 - line 56, column 34: " + [ v.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at TicTacToe line 47, column 14 - line 56, column 34: " + [ row.constructor.name ]);
              })();
              var newBoard = Control_Bind.bind(Data_Either.bindEither)(newRow)(function (nr) {
                  ...
                  throw new Error("Failed pattern match at TicTacToe line 60, column 7 - line 62, column 28: " + [ v.constructor.name ]);
              });
              return newBoard;
          };
      };
  ...
  var invertPiece = function (v) {
      ...
      throw new Error("Failed pattern match at TicTacToe line 19, column 15 - line 21, column 9: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var update = function (model) {
      return function (v) {
          if (v instanceof Play) {
              var v1 = TicTacToe.place(model.board)(v.value0)(model.player);
              ...
              throw new Error("Failed pattern match at Main line 32, column 14 - line 34, column 20: " + [ v1.constructor.name ]);
          };
          if (v instanceof Noop) {
              return model;
          };
          throw new Error("Failed pattern match at Main line 31, column 16 - line 35, column 15: " + [ v.constructor.name ]);
      };
  };
  ...
  var tileView = function (tile) {
      return function (pos) {
          return Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(new Play(pos))) ])([ Spork_Html_Core.text((function () {
              ...
              throw new Error("Failed pattern match at Main line 43, column 14 - line 46, column 5: " + [ tile.constructor.name ]);
          })()) ]);
      };
  };
  var render = function (model) {
      return Spork_Html_Elements.div([  ])(Data_Function.flip(Data_Array.mapWithIndex)(model.board)(function (y) {
          return function (row) {
